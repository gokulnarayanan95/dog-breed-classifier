...
"""
    The CNN architecture is going to be as follows:
    1. Convolution layer #1 : 32 5x5 filters
    2. Pooling layer #1 : 2x2 filter with stride of 2
    3. Convolution layer #2 : 32 5x5 filters
...
def create_cnn_model(features, labels, mode):
    ...
    # The input layer will be the first layer in our cnn
    ...
    # Convolutional Layer #2 and Convolutional Layer #3
